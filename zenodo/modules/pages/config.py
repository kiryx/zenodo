...
PAGES_ISSUE_CATEGORIES = [
    ...
    },
    {
        ...
        'title': 'Partnership',
        'description': (
            'If you are a journal or organisation interested in some form of '
            'parternship with Zenodo, please describe your use cases and '),
        'recipients': ['info@zenodo.org'],
    },
    {
        'key': 'Bug report',
    ...
    },
    {
        ...
        'title': 'Other',
        'description': (
            'Describe your issue in detail, including relevant information '
            'through links or attachments.'),
        'recipients': ['info@zenodo.org'],
    }
]
